const patterns = {
    ...
    circle: [
        new THREE.Vector3(-479.75, -99.99, -8.22),
        new THREE.Vector3(-448.31, -99.82, -225.94),
        new THREE.Vector3(-313.18, -99.78, -277.65),
        new THREE.Vector3(-123.53, -99.78, -278.54),
        new THREE.Vector3(73.99, -99.82, -225.16),
        new THREE.Vector3(173.99, -99.96, -46.77),
        new THREE.Vector3(177.11, -100.06, 80.47),
        new THREE.Vector3(93.72, -100.17, 217.46),
        new THREE.Vector3(-78.82, -100.23, 292.04),
        new THREE.Vector3(-267.51, -100.25, 314.88),
        new THREE.Vector3(-395.62, -100.19, 239.87),
        new THREE.Vector3(-457.26, -100.11, 142.49),    
    ],
    spiral: [
